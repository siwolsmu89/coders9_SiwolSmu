	...
	<div class="body">
		...
		<div class="row justify-content-center">
			<div class="col-5 mt-3 pt-2" style="border: 1px solid lightgray;">
				...
				<p>Main Concept : Reviewing Model 1 Architecture</p>
				<p>Working Period : 2020/07/06 ~ 2020/07/21</p>
				<p>GitHub Link : 
				...
				<p>Back-end Skills Used : Java, JSP, Maria DB</p>
				<p>Front-end Skills Used : HTML, CSS, Bootstrap 4, Javascript</p>
				<p>Tools Used : Eclipse, QueryBox</p>
