			...
			<div class="modal-body">
				<form id="register-form" method="POST" action="../account/register.jsp">
					<div class="input-group">
						...
						<input style="border: none;" type="text" name="userid" onkeyup="resizeInputWidth(event)" onchange="checkId()" />
					...
					<div class="input-group">
						...
						<input style="border: none;" type="text" name="username" onkeyup="resizeInputWidth(event)" />
						<div class="input-group-append">
							<span style="border:none;" class="input-group-text">)</span>
						</div>
					</div>
					<div class="input-group">
						...
						<input style="border: none;" type="text" name="usernickname" onkeyup="resizeInputWidth(event)" />
						<div class="input-group-append">
							<span style="border:none;" class="input-group-text">)</span>
						</div>
					</div>
					...
					<div class="input-group">
						...
						<input style="border: none;" type="text" name="usercontact" onkeyup="resizeInputWidth(event)" />
						<div class="input-group-append">
							<span style="border:none;" class="input-group-text">)</span>
						</div>
					</div>
